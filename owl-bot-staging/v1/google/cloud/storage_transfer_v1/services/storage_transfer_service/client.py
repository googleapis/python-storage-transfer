...
class StorageTransferServiceClient(metaclass=StorageTransferServiceClientMeta):
    ...
    @staticmethod
    def agent_pools_path(project_id: str,agent_pool_id: str,) -> str:
        """Returns a fully-qualified agent_pools string."""
        return "projects/{project_id}/agentPools/{agent_pool_id}".format(project_id=project_id, agent_pool_id=agent_pool_id, )
